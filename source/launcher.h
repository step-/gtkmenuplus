...
enum LauncherElementNdx {LAUNCHER_ELEMENT_CATEGORY = 0, LAUNCHER_ELEMENT_NAME = 1, LAUNCHER_ELEMENT_EXEC = 2, LAUNCHER_ELEMENT_COMMENT = 3, LAUNCHER_ELEMENT_ICON = 4, LAUNCHER_ELEMENT_FORMAT = 5};
